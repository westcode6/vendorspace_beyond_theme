    ...
    <div className="flex max-w-xl my-10 bg-white shadow-md rounded-lg overflow-hidden mx-auto">
     <div className="flex items-center w-full">
      <div className="w-full">
       ...
       <div className="text-gray-600 font-normal text-sm mb-6 mx-3 px-2">
       ...
       <div className="flex justify-start mb-4 border-t border-gray-100">
        ...
        <div className="flex justify-end w-full mt-1 pt-2 pr-5">
         ...
         <span className="transition ease-out duration-300 hover:bg-pink-500 bg-pink-100 h-8 px-2 py-2 text-center rounded-full text-pink-600 cursor-pointer">
          <AiTwotoneHeart />
         </span>
        </div>
       </div>
