 ...
 return (
  <>
   ...
   <div className="grid grid-cols-3 pt-12">
    <div className="lg:col-span-2 col-span-3 bg-gray-50 space-y-8 px-8 md:px-12">
     ...
     <button className="px-4 py-3 rounded-lg bg-pink-500 text-white focus:ring focus:outline-none w-full text-xl font-semibold transition-colors">
      Pay $846.98
     </button>
    </div>
    <div className="col-span-1  lg:block hidden">
     <h1 className="py-6 border-b-2 text-xl bg-white text-gray-600 px-8">
      Order Summary
     </h1>
     <ul className="py-6 border-b space-y-6 px-8 bg-white">
      <li className="grid grid-cols-6 gap-2 border-b-1">
       ...
       <div className="col-span-2 pt-3">
        <div className="flex items-end space-x-2 text-sm justify-end">
      ...
      <li className="grid grid-cols-6 gap-2 border-b-1">
       <div className="col-span-1 self-center">
        <img
         src="/images/green-bag-product.jpg"
         alt="Product"
         className="rounded w-full"
        />
       </div>
